        ...
        <div class="ibox float-e-margins">
          <div class="ibox-content text-center p-md">
            <h2>
              ...
              is provided with two main layouts <br />three skins and separate
              configure options.
            </h2>
        ...
        <div class="ibox float-e-margins">
          <div class="ibox-content text-center p-md">
            ...
            <div class="m-t-md">
              ...
              <div class="p-lg">
                <a href="full_height.html"
                  ><img
                    class="img-responsive img-shadow"
                    src="img/full_height.jpg"
                    alt=""
                /></a>
              </div>
            </div>
